        ...
        <div class="box-body" style="margin-top: 20px;">
            <form action="" method="post">
                <div class="form-group has-feedback <?= form_error('name') ? "has-error" : "null" ?>">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="<?= set_value('name', $customer->name)?>" autocomplete="off" placeholder="Masukan Name Customer">
                ...
                <div class="form-group <?= form_error('gender') ? "has-error" : null?>">
                    ...
                    <select name="gender" id="gender" class="form-control">
                        ...
                        <option value="Pria"<?= $customer->gender == "Pria" ? "selected" : null?>>Pria</option>
                        <option value="Perempuan"<?= $customer->gender == "Perempuan" ? "selected" : null?>>Perempuan</option>
                    </select>
                ...
                <div class="form-group <?= form_error('phone') ? "has-error" : null?>">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control" value="<?= set_value('phone', $customer->phone)?>" autocomplete="off" placeholder="Masukan No Telpon Customer">
                    <span class="text-red"><?= form_error('phone')?></span>
                </div>
                <div class="form-group <?= form_error('address') ? "has-error" : null?>">
                    <label for="address">Address :</label>
                    <textarea name="address" id="address" class="form-control" autocomplete="off" placeholder="Masukan Address Customer"><?= set_value('address', $customer->address)?></textarea>
